...
#ifndef CODE_AVL_TREE_H_T
#define CODE_AVL_TREE_H_T
...
namespace Tree{
    ...
    class AVL_Tree {
        typedef AVL_Node<Key,Data>* Node;
    ...
    public:
        ...
        Data* insert(Key& key, Data& data){ // update trees' info
            ...
            Node new_node = new AVL_Node<Key,Data>(key, data);
            Node node = nullptr;
    ...
    private:
        ...
        void mergeAuxOLD(Iterator& tree1, Iterator& tree2, int& nodes_left, int current_height,
            ...
            if (nodes_left >= 0 && current_height <= max_height){
                if (nodes_left > 0 && current_height < max_height){
                    Node left_node = new AVL_Node<Key, Data>();
                ...
                if (nodes_left > 0 && current_height < max_height){
                    Node right_node = new AVL_Node<Key, Data>();
        ...
        void remove_tree_node(Node& root){
            ...
            if(root->left != nullptr && root->right != nullptr) {
                ...
                AVL_Node<Key, Data>::swap(*root, *next_order);
                if (next_order->right != nullptr) {
                    AVL_Node<Key, Data>::swap(*(next_order->right), *next_order);
                ...
                if (root->left != nullptr){
                    AVL_Node<Key, Data>::swap(*root, *(root->left));
                    delete (root->left);
                    root->left = nullptr;
                }
                else if (root->right != nullptr){
                    AVL_Node<Key, Data>::swap(*root, *(root->right));
                    delete (root->right);
                    root->right = nullptr;
                }
                else { //leaf
